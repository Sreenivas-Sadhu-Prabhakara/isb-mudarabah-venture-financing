package com.bank.islamic.mudarabahventurefinancing.model;
...
/**
 * The BIAN control record for this service domain: "Mudarabah Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Mudarabah Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Mudarabah Facility Fulfillment Arrangement";
